  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-semibold tracking-tight text-gray-900">Contact Groups</h1>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {filteredGroups.map((group) => (
              <Link
                ...
                className="rounded-lg border border-gray-200 bg-white p-6 hover:border-[#DC2626] hover:shadow-md transition-all"
              >
