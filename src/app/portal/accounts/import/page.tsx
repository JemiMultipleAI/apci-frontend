...
export default function ImportAccountsPage() {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const response = await apiClient.post('/import-export/accounts/import', formData, {
        headers: {
      ...
      setError(err.response?.data?.error?.message || 'Failed to import accounts. Please check your CSV file format.');
    } finally {
      setImporting(false);
    }
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-semibold tracking-tight">Import Accounts</h1>
          <p className="text-muted-foreground">
            Upload a CSV file to import accounts
          </p>
        </div>
      </div>
          ...
          <>
            <div>
              ...
              <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
                <li>Required columns: <code className="bg-secondary px-1 rounded">name</code></li>
                <li>Optional columns: <code className="bg-secondary px-1 rounded">website</code>, <code className="bg-secondary px-1 rounded">industry</code>, <code className="bg-secondary px-1 rounded">phone</code>, <code className="bg-secondary px-1 rounded">email</code>, <code className="bg-secondary px-1 rounded">address</code>, <code className="bg-secondary px-1 rounded">city</code>, <code className="bg-secondary px-1 rounded">state</code>, <code className="bg-secondary px-1 rounded">country</code>, <code className="bg-secondary px-1 rounded">postal_code</code></li>
