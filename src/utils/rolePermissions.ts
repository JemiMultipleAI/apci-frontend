 ...
 */
export function hasPermission(role: Role | string | undefined, permission: keyof RolePermissions): boolean {
 ...
 */
export function canCreate(userRole: Role | string | undefined): boolean {
 ...
 */
export function canUpdate(userRole: Role | string | undefined): boolean {
 ...
 */
export function canDelete(userRole: Role | string | undefined): boolean {
 ...
 */
export function canViewUsers(userRole: Role | string | undefined): boolean {
 ...
 */
export function canExportData(userRole: Role | string | undefined): boolean {
 ...
 */
export function canExecuteCampaigns(userRole: Role | string | undefined): boolean {
 ...
 */
export function canManageAccounts(userRole: Role | string | undefined): boolean {
